    ...
    function validate(form) 
{
        ...
        fail = validateForename(form.forename.value)fail += validateSurname(form.surname.value)
...
function validatePassword(field){
    ...
    if (field == "") return "No Password was entered.\n"
            ...
            return "Password require on each of a-z , A_Z and 0-9.\n"
        return ""
